...
(function(root,factory){
  ...
  function adjustedPinPosition(q,c,p){q={...q};if(c.type==='junction')return q;const offset=Number(p.offset)||0;if(q.side==='left'||q.side==='right')q.y=clamp(q.y+offset,c.y+10,c.y+c.h-10);else q.x=clamp(q.x+offset,c.x+10,c.x+c.w-10);return q;}
