...
(function () {
  ...
  function styles() { return `
    ...
    .sl-result-head{display:flex;justify-content:space-between;align-items:center;margin:14px 2px 8px;color:#475569}.sl-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.sl-card{background:#fff;border:1px solid #cbd5e1;border-radius:8px;padding:16px;box-shadow:var(--shadow);display:flex;flex-direction:column}.sl-card-top{display:flex;justify-content:space-between}.sl-system,.sl-topic,.sl-status{display:inline-block;font-size:10px;font-weight:800;border-radius:999px;padding:2px 7px;margin-right:5px}.sl-system{color:#fff;background:#173b5e}.sl-iso{background:#0f766e}.sl-iec{background:#7c3aed}.sl-unece{background:#9a6400}.sl-lv{background:#475569}.sl-uscar{background:#b91c1c}.sl-astm{background:#9a3412}.sl-ipc{background:#0369a1}.sl-ul{background:#c2410c}.sl-topic{background:#e8eef5;color:#274159}.sl-status{color:#08775a;background:#ecfdf5}.sl-status.old{color:#9f281f;background:#fff0ee}.sl-card h3{font-family:var(--mono);font-size:18px;margin:12px 0 2px;color:#173b5e}.sl-card h4{font-size:15px;margin:0 0 6px}.sl-level{font-size:11px;color:#64748b;margin:0 0 8px}.sl-summary{font-size:13px;color:#334155;margin:0 0 10px;flex:1}.sl-tags{display:flex;flex-wrap:wrap;gap:5px}.sl-tags span{font-size:10px;border:1px solid #cbd5e1;padding:2px 6px;background:#f8fafc}.sl-card-actions{display:flex;gap:7px;margin-top:13px;flex-wrap:wrap}.sl-card-actions a{text-decoration:none}
